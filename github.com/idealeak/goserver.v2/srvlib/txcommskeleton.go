...
import (
	"github.com/idealeak/goserver.v2/core/builtin/action"
	"github.com/idealeak/goserver.v2/core/builtin/protocol"
	"github.com/idealeak/goserver.v2/core/logger"
	"github.com/idealeak/goserver.v2/core/netlib"
	"github.com/idealeak/goserver.v2/core/transact"
)
...
func init() {
	transact.RegisteTxCommSkeleton("github.com/idealeak/goserver.v2/srvlib/txcommskeleton", &TxCommSkeleton{})
}
